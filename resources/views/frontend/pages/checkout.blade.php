                    ...
                    <div class="order-details">
                        ...
                        <div class="single-widget payement">
                            <div class="content">
                                ...
                                <button class="btn" id="payment-button">Pay with Khalti</button>
                            </div>
                        </div>
...
<script>
    var config = {
            ...
            "publicKey": "test_public_key_7c29e6d2f338471ab0a4dafc8aca2341",
            "productIdentity": "1234567890",
            "productName": "hello-world",
            "productUrl": "http://127.0.0.1:8000/product-detail/hello-world",
            "paymentPreference": [
                "KHALTI",
                "EBANKING",
                "MOBILE_BANKING",
                ...
                onSuccess(payload) {
                    ...
                    if (payload.idx){
                        ...
                        $.ajax({
                            ...
                            window.location = response. rediretto;
                            }else{ 
                            checkout.hide();
                        }
                       },
